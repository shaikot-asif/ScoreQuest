...
const MatchStatisticsCard = ({
  ...
  return (
    <div>
      {/* Batters Table */}
      <div className="mb-8">
        <h2 className="text-xl mt-2 font-semibold mb-2">Batters</h2>
      ...
      <div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full table-auto border-collapse">
            ...
            <tbody>
              {match?.score[teamKeyBowling]?.playerStats?.map((item) => (
                <tr key={item.playerId} className="hover:bg-gray-100">
                  <td className="p-2 border">
                  ...
                  <td className="p-2 border">{item.overs.extra.wideBall}</td>
